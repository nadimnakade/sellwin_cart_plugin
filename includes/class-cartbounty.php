...
class CartBounty{
	...
	private function define_admin_hooks(){
		...
		$this->loader->add_action( 'wp_ajax_cartbounty_mark_whatsapp', $admin, 'mark_whatsapp_contacted' );
		$this->loader->add_action( 'wp_ajax_cartbounty_update_status', $admin, 'update_cart_status' );
