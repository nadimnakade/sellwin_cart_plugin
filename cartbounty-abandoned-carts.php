...
/**
 * Plugin Name: Sellwin Call Karo - Abandoned Cart Recovery
 * Plugin URI: https://deepskyblue-peafowl-120684.hostingersite.com
 * Description: Forked from CartBounty. Abandoned cart recovery with WhatsApp follow-up tracking for WooCommerce.
 * Version: 1.0.0
 * Text Domain: woo-save-abandoned-carts
 * Author: Sellwin Call Karo
 * Author URI: https://deepskyblue-peafowl-120684.hostingersite.com
...
//Defining constants
if (!defined('CARTBOUNTY_VERSION_NUMBER')) define( 'CARTBOUNTY_VERSION_NUMBER', '1.0.0' );
if (!defined('CARTBOUNTY_PLUGIN_NAME')) define( 'CARTBOUNTY_PLUGIN_NAME', 'Sellwin Call Karo - Abandoned Cart Recovery' );
...
function sellwin_cartbounty_cors_headers() {
	...
	sellwin_cartbounty_send_cors_headers();
...
function sellwin_cartbounty_rest_pre_serve_cors_headers( $served ) {
	sellwin_cartbounty_send_cors_headers();
	return $served;
}
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-cartbounty-rest-api.php';
new CartBounty_REST_API();
